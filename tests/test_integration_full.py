...
class TestFullSystemIntegration:
    ...
    def test_api_media_player_integration(self, mock_vlc, temp_config_file, temp_music_folder):
    ...
    @patch('media_player.VLC_AVAILABLE', True)
    @patch('media.media_player.vlc')
    def test_config_media_player_integration(self, mock_vlc, temp_config_file, temp_music_folder):
    ...
    def test_station_management_workflow(self):
        ...
        if response.status_code == 200:
            ...
            if len(updated_stations) > initial_count:
                ...
                assert updated_stations["workflow_test"]["name"] == "Workflow Test Station"
