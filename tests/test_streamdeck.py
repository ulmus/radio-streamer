...
class TestStreamDeckController:
    ...
    @patch("streamdeck.device_manager.DeviceManager")
    def test_controller_init_with_device(
        self, mock_device_manager, mock_media_player, mock_streamdeck
    ):
    ...
    @patch("streamdeck.device_manager.DeviceManager")
    def test_controller_refresh_stations(
        self, mock_device_manager, mock_media_player, mock_streamdeck
    ):
...
class TestStreamDeckCompatibility:
    ...
    @pytest.mark.skip(
        reason="Implementation behavior changed - refresh_stations not called during initialization"
    )
    @patch("streamdeck.STREAMDECK_AVAILABLE", True)
