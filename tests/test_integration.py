...
class TestAPIMediaPlayerIntegration:
    ...
    def test_api_media_player_flow(self, mock_api_player, mock_vlc, temp_config_file, temp_music_folder):
...
class TestMediaPlayerConfigIntegration:
    ...
    @patch('media_player.VLC_AVAILABLE', True)
    @patch('media.media_player.vlc')
    def test_media_player_config_loading(self, mock_vlc, temp_config_file, temp_music_folder):
    ...
    @patch('media_player.VLC_AVAILABLE', True)
    @patch('media.media_player.vlc')
    def test_media_player_album_loading(self, mock_vlc, temp_config_file, temp_music_folder):
...
class TestStreamDeckIntegration:
    ...
    @patch('media_player.VLC_AVAILABLE', True)
    @patch('media.media_player.vlc')
    def test_streamdeck_media_player_integration(self, mock_vlc, temp_config_file, temp_music_folder):
...
class TestEndToEndFlow:
    ...
    @patch('media_player.VLC_AVAILABLE', True)
    @patch('media.media_player.vlc')
    def test_complete_radio_workflow(self, mock_vlc, temp_config_file, temp_music_folder):
    ...
    @patch('media_player.VLC_AVAILABLE', True)
    @patch('media.media_player.vlc')
    def test_complete_album_workflow(self, mock_vlc, temp_config_file, temp_music_folder):
