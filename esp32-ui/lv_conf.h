 ...
 *LV_DITHER_GRADIENT implies LV_GRADIENT_MAX_STOPS = 256 (not 2)*/
 ...
 *If LV_USE_ASSERT_NULL is enabled an error message will be printed on the log if a NULL pointer is found*/
 ...
 *should also appear on LVGL binding API such as Micropython or native Javascript.*/
